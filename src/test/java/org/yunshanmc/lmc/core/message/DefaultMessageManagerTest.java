...
public class DefaultMessageManagerTest {
    ...
    @Before
    public void setUp() {
        this.messageManager = (DefaultMessageManager) new MockPlugin().setGroupMessage(false).getMessageManager();
    }
    ...
    public void getMessage() {
        ...
        assertEquals("§cMissingLanguage: null_key",
                     this.messageManager.getMessage("null_key").getMessage((Player) null));
    }
