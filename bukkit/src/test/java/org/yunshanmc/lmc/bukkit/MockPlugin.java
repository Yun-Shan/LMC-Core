...
import org.yunshanmc.lmc.core.bukkit.message.BukkitGroupMessageManager;
import org.yunshanmc.lmc.core.bukkit.message.BukkitMessageManager;
...
import org.yunshanmc.lmc.bukkit.resource.MockResourceManager;
...
public class MockPlugin implements LMCPlugin {
    ...
    public MessageManager getMessageManager() {
        if (this.messageManager == null) this.messageManager =
            this.isGroupMM ? new BukkitGroupMessageManager(this, this.getConfigManager())
                : new BukkitMessageManager(this, this.getConfigManager());
