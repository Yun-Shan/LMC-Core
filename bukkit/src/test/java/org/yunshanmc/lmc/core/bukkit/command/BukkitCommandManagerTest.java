...
public class BukkitCommandManagerTest {
    ...
    public void registerCommands() throws Exception {
        ...
        Player fakeBukkitPlayer = (Player) Proxy.newProxyInstance(
            BukkitCommandManagerTest.class.getClassLoader(),
        ...
        BaseLMCCommandSender fakePlayer = new BukkitLMCCommandSender(fakeBukkitPlayer, plugin.getMessageManager()
            .getMessageSender());
